...
# run MOFA using the colon SNF datasets
...
inFiles=( "$inFolder/colon_datasets/colon_mrna.txt" "$inFolder/colon_datasets/colon_mirna.txt" "$inFolder/colon_datasets/colon_cpg.txt")
...
outFile=( "$inFolder/colonMOFA.hdf5" )
