...
# run MOFA using the gbm SNF datasets
...
inFiles=( "$inFolder/gbm_datasets/gbm_mrna.txt" "$inFolder/gbm_datasets/gbm_mirna.txt" "$inFolder/gbm_datasets/gbm_cpg.txt")
