...
# run MOFA using the kidney SNF datasets
...
inFiles=( "$inFolder/kidney_datasets/kidney_mrna.txt" "$inFolder/kidney_datasets/kidney_mirna.txt" "$inFolder/kidney_datasets/kidney_cpg.txt")
...
outFile=( "$inFolder/kidneyMOFA.hdf5" )
